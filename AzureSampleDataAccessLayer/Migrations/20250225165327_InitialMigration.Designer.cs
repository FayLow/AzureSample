...
namespace AzureSampleDataAccessLayer.Migrations
{
    ...
    [Migration("20250225165327_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.BuildVersion", b =>
                {
                    ...
                    b.HasKey("SystemInformationId")
                        .HasName("PK__BuildVer__35E58ECA65B77D36");

                    b.ToTable("BuildVersion", (string)null);
                });

            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int")
                        .HasColumnName("CustomerID");
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnType("int")
                        .HasColumnName("ProductModelID");
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.VGetAllCategory", b =>
                {
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.CustomerAddress", b =>
                {
                    b.HasOne("AzureSampleDataAccessLayer.Models.Address", "Address")
                        .WithMany("CustomerAddresses")
                        .HasForeignKey("AddressId")
                        .IsRequired();

                    b.HasOne("AzureSampleDataAccessLayer.Models.Customer", "Customer")
                        .WithMany("CustomerAddresses")
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.Product", b =>
                {
                    b.HasOne("AzureSampleDataAccessLayer.Models.ProductCategory", "ProductCategory")
                        .WithMany("Products")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("AzureSampleDataAccessLayer.Models.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.ProductCategory", b =>
                {
                    b.HasOne("AzureSampleDataAccessLayer.Models.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.ProductModelProductDescription", b =>
                {
                    b.HasOne("AzureSampleDataAccessLayer.Models.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.SalesOrderDetail", b =>
                {
                    b.HasOne("AzureSampleDataAccessLayer.Models.Product", "Product")
                        .WithMany("SalesOrderDetails")
                        .HasForeignKey("ProductId")
                        .IsRequired();

                    b.HasOne("AzureSampleDataAccessLayer.Models.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("AzureSampleDataAccessLayer.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("AzureSampleDataAccessLayer.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("AzureSampleDataAccessLayer.Models.Address", "ShipToAddress")
